...
#define DHTpin PIN_NUMBER       //Set PIN_NUMBER accroding to your Board Config
#define DHTTYPE DHT11    
#define MQ2_PIN PIN_NUMBER      //Set PIN_NUMBER accroding to your Board Config
#define MQ9_PIN PIN_NUMBER      //Set PIN_NUMBER accroding to your Board Config
#define ALTITUDE 18
...
const char* scriptURL = "Deployment URL here";
//variables for calliberation of sensor values(Change according to your sensor data)......
...
void loop() {
  ...
  temperature = ((dht.readTemperature()*temp_slope)+temp_offset);
  hUMIDITY = ((dht.readHumidity()*humidity_slope)+ humidity_offset);
...
/*
 Change this to do some activity on changing of values(e.g.- buzzer ,light flickering or some kind of 
 activity related to Hardware)
